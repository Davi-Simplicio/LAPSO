...
@onready var interaction_label = $LabelTimeMachine
@onready var sprite = $Door/Sprite2DTimeMachine
@onready var collision = $CollisionShape2DTimeMachine
...
func _ready():
	...
	$InteractionAreaTimeMachine.body_entered.connect(_on_interaction_area_body_entered)
	$InteractionAreaTimeMachine.body_exited.connect(_on_interaction_area_body_exited)
