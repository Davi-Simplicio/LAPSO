...
@onready var interaction_label = $LabelFisica
@onready var sprite = $Door/Sprite2DFisica
@onready var collision = $CollisionShape2DFisica
...
func _ready():
	...
	$InteractionAreaFisica.body_entered.connect(_on_interaction_area_body_entered)
	$InteractionAreaFisica.body_exited.connect(_on_interaction_area_body_exited)
